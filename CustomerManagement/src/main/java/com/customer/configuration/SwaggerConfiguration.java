...
import springfox.documentation.swagger2.annotations.EnableSwagger2;
    ...
    public class SwaggerConfiguration {
		...
		private ApiInfo apiInfo() {
			...
			return new ApiInfo("Deals And Coupon",
	                "<h1>API reference example for Customer Microservice</h1>", "1.0.0", "Public API",
	                new springfox.documentation.service.Contact("Premal Miglani", "https://github.com/PremalMiglani", "premalmiglani123@gmail.com"),
